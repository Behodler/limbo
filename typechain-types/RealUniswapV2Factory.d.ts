...
interface RealUniswapV2FactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class RealUniswapV2Factory extends BaseContract {
  ...
  interface: RealUniswapV2FactoryInterface;
