...
interface AdjustFlanFeeOnTransferProposalInterface
  extends ethers.utils.Interface {
  functions: {
    "description()": FunctionFragment;
    "orchestrateExecute()": FunctionFragment;
    "parameterize(address,uint8)": FunctionFragment;
...
export class AdjustFlanFeeOnTransferProposal extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[string, number] & { flan: string; fee: number }>;
  };
