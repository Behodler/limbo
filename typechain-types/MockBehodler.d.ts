...
interface MockBehodlerInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setPriceMultiplier(uint256)": FunctionFragment;
...
export class MockBehodler extends BaseContract {
  ...
  interface: MockBehodlerInterface;
