...
interface MorgothTokenApproverLikeInterface extends ethers.utils.Interface {
  functions: {
...
export class MorgothTokenApproverLike extends BaseContract {
  ...
  interface: MorgothTokenApproverLikeInterface;
