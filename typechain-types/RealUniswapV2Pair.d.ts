...
interface RealUniswapV2PairInterface extends ethers.utils.Interface {
  functions: {
...
export class RealUniswapV2Pair extends BaseContract {
  ...
  interface: RealUniswapV2PairInterface;
