...
import "./facades/SnufferCap.sol" as Snuffer;
import "../../../openzeppelin/Ownable.sol";
import "../../../facades/LachesisLike.sol";
import "../../../openzeppelin/IERC20.sol";
import "../../../facades/BigConstantsLike.sol";
import "./ProxyHandler.sol" as PH;
...
contract LiquidityReceiver is Ownable {
   ...
   */
  event PyroTokenDeployed(address pyroToken, address baseToken, string name, string symbol);
  ...
  function registerPyroToken(
    ...
    address p = Create2.deploy(keccak256(abi.encode(baseToken)), bigConstants.PYROTOKEN_BYTECODE());
    PyroToken(p).initialize(baseToken, name, symbol, decimals, address(bigConstants), config.proxyHandler);
